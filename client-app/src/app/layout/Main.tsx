                  ...
                  <div className="owl-carousel owl-theme" id="products-carousel">
                    <div>
                      <div className="product-item pb-3">
                        <div className="product-image">
                          <img alt="image5" src="../assets/img/products/product-4-50.png" className="img-fluid"/>
                        </div>
                    ...
                    <div>
                      <div className="product-item">
                        <div className="product-image">
                          <img alt="image55" src="../assets/img/products/product-3-50.png" className="img-fluid"/>
                        </div>
                        <div className="product-details">
                    ...
                    <div>
                      <div className="product-item">
                        <div className="product-image">
                          <img alt="image56" src="../assets/img/products/product-1-50.png" className="img-fluid"/>
                        </div>
                        <div className="product-details">
                  ...
                  <div className="row">
                    <div className="col-sm-6">
                      ...
                      <ul className="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                        <li className="media">
                          <img className="img-fluid mt-1 img-shadow" src="../node_modules/flag-icon-css/flags/4x3/id.svg" alt="image1" width="40"/>
                        ...
                        <li className="media">
                          <img className="img-fluid mt-1 img-shadow" src="../node_modules/flag-icon-css/flags/4x3/my.svg" alt="image2" width="40"/>
                          <div className="media-body ml-3">
                        ...
                        <li className="media">
                          <img className="img-fluid mt-1 img-shadow" src="../node_modules/flag-icon-css/flags/4x3/us.svg" alt="image3" width="40"/>
                          <div className="media-body ml-3">
                    ...
                    <div className="col-sm-6 mt-sm-0 mt-4">
                      ...
                      <ul className="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                        <li className="media">
                          <img className="img-fluid mt-1 img-shadow" src="../node_modules/flag-icon-css/flags/4x3/id.svg" alt="image76" width="40"/>
                          <div className="media-body ml-3">
                            <div className="media-title">Indonesia</div>
                        ...
                        <li className="media">
                          <img className="img-fluid mt-1 img-shadow" src="../node_modules/flag-icon-css/flags/4x3/ps.svg" alt="image766" width="40"/>
                          <div className="media-body ml-3">
                        ...
                        <li className="media">
                          <img className="img-fluid mt-1 img-shadow" src="../node_modules/flag-icon-css/flags/4x3/de.svg" alt="image8" width="40"/>
                          <div className="media-body ml-3">
